package com.example.p12plusplus
...
import com.example.p12plusplus.ui.theme.P12PlusPlusTheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val faker = Faker()
//с помощью Faker генерируется 100 объектов City и загоняется в список
